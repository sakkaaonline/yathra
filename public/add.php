...
?>
<a href="add.php" class="btn selected">EVENT UPLOAD</a>
<a href="gallery.php" class="btn">GALLERY UPLOAD</a>

<div class="border">
<h3 class="header">UPLOAD POST IMAGE</h3>
...
<div class="border">
<h3 class="header">LIST OF POST IMAGES</h3>
<?php echo $filenames; ?>
</div>
<div class="border">
<h3 class="header">EDIT EVENT JSON</h3>
